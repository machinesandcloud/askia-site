...
---
Case Study Framework should make your value obvious in under 10 seconds. This guide focuses on how to protect negotiation leverage without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your case study framework does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 34% improvement, 4x faster).
