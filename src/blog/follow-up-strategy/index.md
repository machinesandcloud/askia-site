...
---
Follow-Up Strategy should make your value obvious in under 10 seconds. This guide focuses on how to signal senior scope without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your follow-up strategy does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 43% improvement, 5x faster).
