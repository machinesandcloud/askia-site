...
---
Negotiation Email should make your value obvious in under 10 seconds. This guide focuses on how to reduce ambiguity without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your negotiation email does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 42% improvement, 7x faster).
