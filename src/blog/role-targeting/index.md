...
---
Role Targeting should make your value obvious in under 10 seconds. This guide focuses on how to turn scope into impact without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your role targeting does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 29% improvement, 6x faster).
