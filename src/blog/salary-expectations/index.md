...
---
Salary Expectations should make your value obvious in under 10 seconds. This guide focuses on how to speed up decisions without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your salary expectations does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 23% improvement, 2x faster).
