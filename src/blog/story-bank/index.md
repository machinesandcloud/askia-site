...
---
Story Bank should make your value obvious in under 10 seconds. This guide focuses on how to protect negotiation leverage without inflating claims.

## Quick answer

Lead with scope, quantify outcomes, and make the level fit unmistakable. If your story bank does not show impact, the loop stalls.
...
2. Surface three outcomes (e.g., 36% improvement, 4x faster).
